...
class Docstring(BrowseGrammar):
	  ...
	  if rule_directive.has_key('params'):
...
# FIXME
#         browse_rule_directives(rule['prototype']['rule_directive'], lang_rule_directive)
	  self.sRes += " ::="
