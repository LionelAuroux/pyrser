...
def process_signature(app, what, name, obj, options,
    ...
    if what == "function" or what == "method":
        ...
        if ((sigf.return_annotation is not sigf.empty
             and hasattr(sigf.return_annotation, '__name__'))):
...
latex_documents = [
    ('index', 'pyrser.tex', 'pyrser Documentation',
     'Pyrser authors', 'manual'),
]
...
man_pages = [
    ('index', 'pyrser', 'pyrser Documentation',
     ['Pyrser authors'], 1)
]
...
texinfo_documents = [
    ('index', 'pyrser', 'pyrser Documentation',
     'Pyrser authors', 'pyrser', 'One line description of project.',
     'Miscellaneous'),
]
